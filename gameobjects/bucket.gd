...
@onready var textures: Dictionary = {
	...
	Potions.Types.WeakHealing: preload("res://assets/bucket_weakhealing.png"),
	Potions.Types.WeakAntidote: preload("res://assets/bucket_weakantidote.png"),
	Potions.Types.MinorStrength: preload("res://assets/bucket_minorstrength.png"),
